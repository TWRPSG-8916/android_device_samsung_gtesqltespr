...
PB_MAINTAINER := DJABHipHop
PB_DISABLE_MIUI_SPECIFIC_FEATURES := 1
PB_DISABLE_MIUI_OTA_BY_DEFAULT := 1
PB_FLASHLIGHT_THEME_SUPPORT := 0
PB_CHECK_OVERWRITE_ATTEMPTS :=1
PB_INCREMENTAL_PACKAGE := 0
PB_METADATA_PRE_BUILD := 0
PB_MIUI_ZIP_TMP := 0
PB_REMOVE_AAPT :=1
